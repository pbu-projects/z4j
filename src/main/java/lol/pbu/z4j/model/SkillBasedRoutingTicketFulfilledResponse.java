...
@AllArgsConstructor
@Data
@JsonPropertyOrder(SkillBasedRoutingTicketFulfilledResponse.JSON_PROPERTY_FULFILLED_TICKET_IDS)
@Serdeable
public class SkillBasedRoutingTicketFulfilledResponse {

    public static final String JSON_PROPERTY_FULFILLED_TICKET_IDS = "fulfilled_ticket_ids";
    ...
    public SkillBasedRoutingTicketFulfilledResponse addFulfilledTicketIdsItem(Long fulfilledTicketIdsItem) {
        ...
        fulfilledTicketIds.add(fulfilledTicketIdsItem);
        return this;
    }
