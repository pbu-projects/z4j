...
@Setter
@JsonPropertyOrder({
    TicketObject.JSON_PROPERTY_REQUESTER_ID,
    TicketObject.JSON_PROPERTY_ALLOW_ATTACHMENTS,
    TicketObject.JSON_PROPERTY_ALLOW_CHANNELBACK,
    TicketObject.JSON_PROPERTY_ASSIGNEE_EMAIL,
    TicketObject.JSON_PROPERTY_ASSIGNEE_ID,
    TicketObject.JSON_PROPERTY_ATTRIBUTE_VALUE_IDS,
    TicketObject.JSON_PROPERTY_BRAND_ID,
    TicketObject.JSON_PROPERTY_COLLABORATOR_IDS,
    TicketObject.JSON_PROPERTY_COLLABORATORS,
    TicketObject.JSON_PROPERTY_COMMENT,
    TicketObject.JSON_PROPERTY_CREATED_AT,
    TicketObject.JSON_PROPERTY_CUSTOM_FIELDS,
    TicketObject.JSON_PROPERTY_CUSTOM_STATUS_ID,
    TicketObject.JSON_PROPERTY_DESCRIPTION,
    TicketObject.JSON_PROPERTY_DUE_AT,
    TicketObject.JSON_PROPERTY_EMAIL_CC_IDS,
    TicketObject.JSON_PROPERTY_EMAIL_CCS,
    TicketObject.JSON_PROPERTY_ENCODED_ID,
    TicketObject.JSON_PROPERTY_EXTERNAL_ID,
    TicketObject.JSON_PROPERTY_FOLLOWER_IDS,
    TicketObject.JSON_PROPERTY_FOLLOWERS,
    TicketObject.JSON_PROPERTY_FOLLOWUP_IDS,
    TicketObject.JSON_PROPERTY_FORUM_TOPIC_ID,
    TicketObject.JSON_PROPERTY_FROM_MESSAGING_CHANNEL,
    TicketObject.JSON_PROPERTY_GENERATED_TIMESTAMP,
    TicketObject.JSON_PROPERTY_GROUP_ID,
    TicketObject.JSON_PROPERTY_HAS_INCIDENTS,
    TicketObject.JSON_PROPERTY_ID,
    TicketObject.JSON_PROPERTY_IS_PUBLIC,
    TicketObject.JSON_PROPERTY_MACRO_ID,
    TicketObject.JSON_PROPERTY_MACRO_IDS,
    TicketObject.JSON_PROPERTY_METADATA,
    TicketObject.JSON_PROPERTY_ORGANIZATION_ID,
    TicketObject.JSON_PROPERTY_PRIORITY,
    TicketObject.JSON_PROPERTY_PROBLEM_ID,
    TicketObject.JSON_PROPERTY_RAW_SUBJECT,
    TicketObject.JSON_PROPERTY_RECIPIENT,
    TicketObject.JSON_PROPERTY_REQUESTER,
    TicketObject.JSON_PROPERTY_SAFE_UPDATE,
    TicketObject.JSON_PROPERTY_SATISFACTION_RATING,
    TicketObject.JSON_PROPERTY_SHARING_AGREEMENT_IDS,
    TicketObject.JSON_PROPERTY_STATUS,
    TicketObject.JSON_PROPERTY_SUBJECT,
    TicketObject.JSON_PROPERTY_SUBMITTER_ID,
    TicketObject.JSON_PROPERTY_TAGS,
    TicketObject.JSON_PROPERTY_TICKET_FORM_ID,
    TicketObject.JSON_PROPERTY_TYPE,
    TicketObject.JSON_PROPERTY_UPDATED_AT,
    TicketObject.JSON_PROPERTY_UPDATED_STAMP,
    TicketObject.JSON_PROPERTY_URL,
    TicketObject.JSON_PROPERTY_VIA,
    TicketObject.JSON_PROPERTY_VIA_FOLLOWUP_SOURCE_ID,
    TicketObject.JSON_PROPERTY_VIA_ID,
    TicketObject.JSON_PROPERTY_VOICE_COMMENT,
})
@Serdeable
public class TicketObject {
    ...
    public TicketObject(Integer requesterId) {
     ...
     *
     * @return The same instance of TicketObject for chaining.
     */
    public TicketObject addAttributeValueIdsItem(Integer attributeValueIdsItem) {
     ...
     * @return The same instance of TicketObject for chaining.
     */
    public TicketObject addCollaboratorIdsItem(Integer collaboratorIdsItem) {
     ...
     * @return The same instance of TicketObject for chaining.
     */
    public TicketObject addCollaboratorsItem(CollaboratorObject collaboratorsItem) {
     ...
     * @return The same instance of TicketObject for chaining.
     */
    public TicketObject addCustomFieldsItem(ApprovalTicketDetailsCustomFieldsInner customFieldsItem) {
     ...
     * @return The same instance of TicketObject for chaining.
     */
    public TicketObject addEmailCcIdsItem(Integer emailCcIdsItem) {
        if (emailCcIds == null) {
     ...
     * @return The same instance of TicketObject for chaining.
     */
    public TicketObject addFollowerIdsItem(Integer followerIdsItem) {
        if (followerIds == null) {
     ...
     * @return The same instance of TicketObject for chaining.
     */
    public TicketObject addMacroIdsItem(Integer macroIdsItem) {
        if (macroIds == null) {
     ...
     * @return The same instance of TicketObject for chaining.
     */
    public TicketObject addSharingAgreementIdsItem(Integer sharingAgreementIdsItem) {
     ...
     * @return The same instance of TicketObject for chaining.
     */
    public TicketObject addTagsItem(String tagsItem) {
        if (tags == null) {
            tags = new ArrayList<>();
        }
        tags.add(tagsItem);
