...
@Data
@JsonPropertyOrder({
    OrganizationsResponse.JSON_PROPERTY_COUNT,
    OrganizationsResponse.JSON_PROPERTY_NEXT_PAGE,
    OrganizationsResponse.JSON_PROPERTY_ORGANIZATIONS,
    OrganizationsResponse.JSON_PROPERTY_PREVIOUS_PAGE,
})
@Serdeable
public class OrganizationsResponse {
     ...
     *
     * @return The same instance of OrganizationsResponse for chaining.
     */
    public OrganizationsResponse addOrganizationsItem(OrganizationObject organizationsItem) {
