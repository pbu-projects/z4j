...
@Setter
@JsonPropertyOrder({
    MacroCommonObject.JSON_PROPERTY_ACTIONS,
    MacroCommonObject.JSON_PROPERTY_TITLE,
    MacroCommonObject.JSON_PROPERTY_ACTIVE,
    MacroCommonObject.JSON_PROPERTY_CREATED_AT,
    MacroCommonObject.JSON_PROPERTY_DEFAULT,
    MacroCommonObject.JSON_PROPERTY_DESCRIPTION,
    MacroCommonObject.JSON_PROPERTY_ID,
    MacroCommonObject.JSON_PROPERTY_POSITION,
    MacroCommonObject.JSON_PROPERTY_RAW_TITLE,
    MacroCommonObject.JSON_PROPERTY_RESTRICTION,
    MacroCommonObject.JSON_PROPERTY_UPDATED_AT,
    MacroCommonObject.JSON_PROPERTY_URL,
})
@Serdeable
public class MacroCommonObject {
    ...
    public MacroCommonObject(List<@Valid ActionObject> actions, String title) {
     ...
     *
     * @return The same instance of MacroCommonObject for chaining.
     */
    public MacroCommonObject addActionsItem(ActionObject actionsItem) {
     ...
     * @return The same instance of MacroCommonObject for chaining.
     */
    public MacroCommonObject putRestrictionItem(String key, Object restrictionItem) {
        if (restriction == null) {
