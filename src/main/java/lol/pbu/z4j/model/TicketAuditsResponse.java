...
@Data
@JsonPropertyOrder({
    TicketAuditsResponse.JSON_PROPERTY_AFTER_CURSOR,
    TicketAuditsResponse.JSON_PROPERTY_AFTER_URL,
    TicketAuditsResponse.JSON_PROPERTY_AUDITS,
    TicketAuditsResponse.JSON_PROPERTY_BEFORE_CURSOR,
    TicketAuditsResponse.JSON_PROPERTY_BEFORE_URL,
})
@Serdeable
public class TicketAuditsResponse {
     ...
     *
     * @return The same instance of TicketAuditsResponse for chaining.
     */
    public TicketAuditsResponse addAuditsItem(TicketAuditObject auditsItem) {
        if (audits == null) {
