...
import java.util.Map;
import lol.pbu.z4j.model.UserForAdmin;
import lol.pbu.z4j.model.UserForEndUser;
...
@Setter
@JsonPropertyOrder({
    UserObject.JSON_PROPERTY_NAME,
    UserObject.JSON_PROPERTY_ACTIVE,
    UserObject.JSON_PROPERTY_AGENT_BRAND_IDS,
    UserObject.JSON_PROPERTY_ALIAS,
    UserObject.JSON_PROPERTY_CHAT_ONLY,
    UserObject.JSON_PROPERTY_CREATED_AT,
    UserObject.JSON_PROPERTY_CUSTOM_ROLE_ID,
    UserObject.JSON_PROPERTY_DEFAULT_GROUP_ID,
    UserObject.JSON_PROPERTY_DETAILS,
    UserObject.JSON_PROPERTY_EMAIL,
    UserObject.JSON_PROPERTY_EXTERNAL_ID,
    UserObject.JSON_PROPERTY_IANA_TIME_ZONE,
    UserObject.JSON_PROPERTY_ID,
    UserObject.JSON_PROPERTY_LAST_LOGIN_AT,
    UserObject.JSON_PROPERTY_LOCALE,
    UserObject.JSON_PROPERTY_LOCALE_ID,
    UserObject.JSON_PROPERTY_MODERATOR,
    UserObject.JSON_PROPERTY_NOTES,
    UserObject.JSON_PROPERTY_ONLY_PRIVATE_COMMENTS,
    UserObject.JSON_PROPERTY_ORGANIZATION_ID,
    UserObject.JSON_PROPERTY_PHONE,
    UserObject.JSON_PROPERTY_PHOTO,
    UserObject.JSON_PROPERTY_REMOTE_PHOTO_URL,
    UserObject.JSON_PROPERTY_REPORT_CSV,
    UserObject.JSON_PROPERTY_RESTRICTED_AGENT,
    UserObject.JSON_PROPERTY_ROLE,
    UserObject.JSON_PROPERTY_ROLE_TYPE,
    UserObject.JSON_PROPERTY_SHARED,
    UserObject.JSON_PROPERTY_SHARED_AGENT,
    UserObject.JSON_PROPERTY_SHARED_PHONE_NUMBER,
    UserObject.JSON_PROPERTY_SIGNATURE,
    UserObject.JSON_PROPERTY_SUSPENDED,
    UserObject.JSON_PROPERTY_TAGS,
    UserObject.JSON_PROPERTY_TICKET_RESTRICTION,
    UserObject.JSON_PROPERTY_TIME_ZONE,
    UserObject.JSON_PROPERTY_TWO_FACTOR_AUTH_ENABLED,
    UserObject.JSON_PROPERTY_UPDATED_AT,
    UserObject.JSON_PROPERTY_URL,
    UserObject.JSON_PROPERTY_USER_FIELDS,
    UserObject.JSON_PROPERTY_VERIFIED,
})
@Serdeable
public class UserObject extends HashMap<String, Object> {
     ...
     *
     * @return The same instance of UserObject for chaining.
     */
    public UserObject addAgentBrandIdsItem(Integer agentBrandIdsItem) {
     ...
     * @return The same instance of UserObject for chaining.
     */
    public UserObject putPhotoItem(String key, Object photoItem) {
        if (photo == null) {
            photo = new HashMap<>();
        }
     ...
     * @return The same instance of UserObject for chaining.
     */
    public UserObject addTagsItem(String tagsItem) {
        if (tags == null) {
            tags = new ArrayList<>();
        }
        tags.add(tagsItem);
     ...
     * @return The same instance of UserObject for chaining.
     */
    public UserObject putUserFieldsItem(String key, Object userFieldsItem) {
        if (userFields == null) {
