...
import lol.pbu.z4j.model.CustomStatusUpdateInput;
...
@AllArgsConstructor
@Data
@JsonPropertyOrder(CustomStatusUpdateRequest.JSON_PROPERTY_CUSTOM_STATUS)
@Serdeable
public class CustomStatusUpdateRequest {
    ...
    private CustomStatusUpdateInput customStatus;
