...
/**
 * <p>The full user record of the agent making the request. See <a href=\"/api-reference/ticketing/users/users/\">Users</a></p>
 */
...
@Setter
@JsonPropertyOrder({
    ActivityObjectUser.JSON_PROPERTY_NAME,
    ActivityObjectUser.JSON_PROPERTY_ACTIVE,
    ActivityObjectUser.JSON_PROPERTY_AGENT_BRAND_IDS,
    ActivityObjectUser.JSON_PROPERTY_ALIAS,
    ActivityObjectUser.JSON_PROPERTY_CHAT_ONLY,
    ActivityObjectUser.JSON_PROPERTY_CREATED_AT,
    ActivityObjectUser.JSON_PROPERTY_CUSTOM_ROLE_ID,
    ActivityObjectUser.JSON_PROPERTY_DEFAULT_GROUP_ID,
    ActivityObjectUser.JSON_PROPERTY_DETAILS,
    ActivityObjectUser.JSON_PROPERTY_EMAIL,
    ActivityObjectUser.JSON_PROPERTY_EXTERNAL_ID,
    ActivityObjectUser.JSON_PROPERTY_IANA_TIME_ZONE,
    ActivityObjectUser.JSON_PROPERTY_ID,
    ActivityObjectUser.JSON_PROPERTY_LAST_LOGIN_AT,
    ActivityObjectUser.JSON_PROPERTY_LOCALE,
    ActivityObjectUser.JSON_PROPERTY_LOCALE_ID,
    ActivityObjectUser.JSON_PROPERTY_MODERATOR,
    ActivityObjectUser.JSON_PROPERTY_NOTES,
    ActivityObjectUser.JSON_PROPERTY_ONLY_PRIVATE_COMMENTS,
    ActivityObjectUser.JSON_PROPERTY_ORGANIZATION_ID,
    ActivityObjectUser.JSON_PROPERTY_PHONE,
    ActivityObjectUser.JSON_PROPERTY_PHOTO,
    ActivityObjectUser.JSON_PROPERTY_REMOTE_PHOTO_URL,
    ActivityObjectUser.JSON_PROPERTY_REPORT_CSV,
    ActivityObjectUser.JSON_PROPERTY_RESTRICTED_AGENT,
    ActivityObjectUser.JSON_PROPERTY_ROLE,
    ActivityObjectUser.JSON_PROPERTY_ROLE_TYPE,
    ActivityObjectUser.JSON_PROPERTY_SHARED,
    ActivityObjectUser.JSON_PROPERTY_SHARED_AGENT,
    ActivityObjectUser.JSON_PROPERTY_SHARED_PHONE_NUMBER,
    ActivityObjectUser.JSON_PROPERTY_SIGNATURE,
    ActivityObjectUser.JSON_PROPERTY_SUSPENDED,
    ActivityObjectUser.JSON_PROPERTY_TAGS,
    ActivityObjectUser.JSON_PROPERTY_TICKET_RESTRICTION,
    ActivityObjectUser.JSON_PROPERTY_TIME_ZONE,
    ActivityObjectUser.JSON_PROPERTY_TWO_FACTOR_AUTH_ENABLED,
    ActivityObjectUser.JSON_PROPERTY_UPDATED_AT,
    ActivityObjectUser.JSON_PROPERTY_URL,
    ActivityObjectUser.JSON_PROPERTY_USER_FIELDS,
    ActivityObjectUser.JSON_PROPERTY_VERIFIED,
})
@Serdeable
public class ActivityObjectUser {
    ...
    public ActivityObjectUser(String name) {
        this.name = name;
    }
     ...
     *
     * @return The same instance of ActivityObjectUser for chaining.
     */
    public ActivityObjectUser addAgentBrandIdsItem(Integer agentBrandIdsItem) {
     ...
     * @return The same instance of ActivityObjectUser for chaining.
     */
    public ActivityObjectUser putPhotoItem(String key, Object photoItem) {
        if (photo == null) {
            photo = new HashMap<>();
        }
     ...
     * @return The same instance of ActivityObjectUser for chaining.
     */
    public ActivityObjectUser addTagsItem(String tagsItem) {
        if (tags == null) {
            tags = new ArrayList<>();
        }
        tags.add(tagsItem);
     ...
     * @return The same instance of ActivityObjectUser for chaining.
     */
    public ActivityObjectUser putUserFieldsItem(String key, Object userFieldsItem) {
        if (userFields == null) {
