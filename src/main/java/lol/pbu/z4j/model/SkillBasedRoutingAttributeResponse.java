...
@AllArgsConstructor
@Data
@JsonPropertyOrder(SkillBasedRoutingAttributeResponse.JSON_PROPERTY_ATTRIBUTE)
@Serdeable
public class SkillBasedRoutingAttributeResponse {
    ...
    private SkillBasedRoutingAttributeObject attribute;
