...
import lol.pbu.z4j.model.AttachmentBaseObject;
...
/**
 * <p>A file represented as an <a href=\"/api-reference/ticketing/tickets/ticket-attachments/\">Attachment</a> object</p>
 */
...
public class AttachmentObject {
    ...
    @JsonInclude(JsonInclude.Include.USE_DEFAULTS)
    private List<@Valid AttachmentBaseObject> thumbnails;
