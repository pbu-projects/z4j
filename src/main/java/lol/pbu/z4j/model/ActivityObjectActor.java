...
/**
 * <p>The full user record of the user responsible for the ticket activity. See <a href=\"/api-reference/ticketing/users/users/\">Users</a></p>
 */
...
@Setter
@JsonPropertyOrder({
    ActivityObjectActor.JSON_PROPERTY_NAME,
    ActivityObjectActor.JSON_PROPERTY_ACTIVE,
    ActivityObjectActor.JSON_PROPERTY_AGENT_BRAND_IDS,
    ActivityObjectActor.JSON_PROPERTY_ALIAS,
    ActivityObjectActor.JSON_PROPERTY_CHAT_ONLY,
    ActivityObjectActor.JSON_PROPERTY_CREATED_AT,
    ActivityObjectActor.JSON_PROPERTY_CUSTOM_ROLE_ID,
    ActivityObjectActor.JSON_PROPERTY_DEFAULT_GROUP_ID,
    ActivityObjectActor.JSON_PROPERTY_DETAILS,
    ActivityObjectActor.JSON_PROPERTY_EMAIL,
    ActivityObjectActor.JSON_PROPERTY_EXTERNAL_ID,
    ActivityObjectActor.JSON_PROPERTY_IANA_TIME_ZONE,
    ActivityObjectActor.JSON_PROPERTY_ID,
    ActivityObjectActor.JSON_PROPERTY_LAST_LOGIN_AT,
    ActivityObjectActor.JSON_PROPERTY_LOCALE,
    ActivityObjectActor.JSON_PROPERTY_LOCALE_ID,
    ActivityObjectActor.JSON_PROPERTY_MODERATOR,
    ActivityObjectActor.JSON_PROPERTY_NOTES,
    ActivityObjectActor.JSON_PROPERTY_ONLY_PRIVATE_COMMENTS,
    ActivityObjectActor.JSON_PROPERTY_ORGANIZATION_ID,
    ActivityObjectActor.JSON_PROPERTY_PHONE,
    ActivityObjectActor.JSON_PROPERTY_PHOTO,
    ActivityObjectActor.JSON_PROPERTY_REMOTE_PHOTO_URL,
    ActivityObjectActor.JSON_PROPERTY_REPORT_CSV,
    ActivityObjectActor.JSON_PROPERTY_RESTRICTED_AGENT,
    ActivityObjectActor.JSON_PROPERTY_ROLE,
    ActivityObjectActor.JSON_PROPERTY_ROLE_TYPE,
    ActivityObjectActor.JSON_PROPERTY_SHARED,
    ActivityObjectActor.JSON_PROPERTY_SHARED_AGENT,
    ActivityObjectActor.JSON_PROPERTY_SHARED_PHONE_NUMBER,
    ActivityObjectActor.JSON_PROPERTY_SIGNATURE,
    ActivityObjectActor.JSON_PROPERTY_SUSPENDED,
    ActivityObjectActor.JSON_PROPERTY_TAGS,
    ActivityObjectActor.JSON_PROPERTY_TICKET_RESTRICTION,
    ActivityObjectActor.JSON_PROPERTY_TIME_ZONE,
    ActivityObjectActor.JSON_PROPERTY_TWO_FACTOR_AUTH_ENABLED,
    ActivityObjectActor.JSON_PROPERTY_UPDATED_AT,
    ActivityObjectActor.JSON_PROPERTY_URL,
    ActivityObjectActor.JSON_PROPERTY_USER_FIELDS,
    ActivityObjectActor.JSON_PROPERTY_VERIFIED,
})
@Serdeable
public class ActivityObjectActor {
    ...
    public ActivityObjectActor(String name) {
        this.name = name;
    }
     ...
     *
     * @return The same instance of ActivityObjectActor for chaining.
     */
    public ActivityObjectActor addAgentBrandIdsItem(Integer agentBrandIdsItem) {
     ...
     * @return The same instance of ActivityObjectActor for chaining.
     */
    public ActivityObjectActor putPhotoItem(String key, Object photoItem) {
        if (photo == null) {
            photo = new HashMap<>();
        }
     ...
     * @return The same instance of ActivityObjectActor for chaining.
     */
    public ActivityObjectActor addTagsItem(String tagsItem) {
        if (tags == null) {
            tags = new ArrayList<>();
        }
        tags.add(tagsItem);
     ...
     * @return The same instance of ActivityObjectActor for chaining.
     */
    public ActivityObjectActor putUserFieldsItem(String key, Object userFieldsItem) {
        if (userFields == null) {
