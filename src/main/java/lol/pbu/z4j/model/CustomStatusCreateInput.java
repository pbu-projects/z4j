...
@Data
@JsonPropertyOrder({
    CustomStatusCreateInput.JSON_PROPERTY_ACTIVE,
    CustomStatusCreateInput.JSON_PROPERTY_AGENT_LABEL,
    CustomStatusCreateInput.JSON_PROPERTY_DESCRIPTION,
    CustomStatusCreateInput.JSON_PROPERTY_END_USER_DESCRIPTION,
    CustomStatusCreateInput.JSON_PROPERTY_END_USER_LABEL,
    CustomStatusCreateInput.JSON_PROPERTY_STATUS_CATEGORY,
})
@Serdeable
public class CustomStatusCreateInput {
