...
import lol.pbu.z4j.model.CustomStatusCreateInput;
...
@AllArgsConstructor
@Data
@JsonPropertyOrder(CustomStatusCreateRequest.JSON_PROPERTY_CUSTOM_STATUS)
@Serdeable
public class CustomStatusCreateRequest {
    ...
    private CustomStatusCreateInput customStatus;
