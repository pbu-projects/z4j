...
@Data
@JsonPropertyOrder({
    OffsetPaginationObject.JSON_PROPERTY_COUNT,
    OffsetPaginationObject.JSON_PROPERTY_NEXT_PAGE,
    OffsetPaginationObject.JSON_PROPERTY_PREVIOUS_PAGE,
})
@Serdeable
public class OffsetPaginationObject {
