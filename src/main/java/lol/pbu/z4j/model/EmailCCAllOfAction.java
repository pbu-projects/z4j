...
public enum EmailCCAllOfAction {
    ...
    public static final Map<String, EmailCCAllOfAction> VALUE_MAPPING = Map.copyOf(Arrays.stream(values())
     ...
     */
    @JsonCreator
    public static EmailCCAllOfAction fromValue(String value) {
