...
@AllArgsConstructor
@Data
@JsonPropertyOrder(TriggerCategoriesResponse.JSON_PROPERTY_TRIGGER_CATEGORIES)
@Serdeable
public class TriggerCategoriesResponse {
     ...
     *
     * @return The same instance of TriggerCategoriesResponse for chaining.
     */
    public TriggerCategoriesResponse addTriggerCategoriesItem(TriggerCategory triggerCategoriesItem) {
