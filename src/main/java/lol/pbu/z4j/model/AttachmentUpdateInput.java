...
@AllArgsConstructor
@Data
@JsonPropertyOrder(AttachmentUpdateInput.JSON_PROPERTY_MALWARE_ACCESS_OVERRIDE)
@Serdeable
public class AttachmentUpdateInput {

    public static final String JSON_PROPERTY_MALWARE_ACCESS_OVERRIDE = "malware_access_override";

    /**
     * <p>If true, allows access to attachments with detected malware.</p>
     */
    @Nullable
