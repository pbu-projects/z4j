...
@Data
@JsonPropertyOrder({
    ViewsResponse.JSON_PROPERTY_COUNT,
    ViewsResponse.JSON_PROPERTY_NEXT_PAGE,
    ViewsResponse.JSON_PROPERTY_PREVIOUS_PAGE,
    ViewsResponse.JSON_PROPERTY_VIEWS,
})
@Serdeable
public class ViewsResponse {
    ...
    @JsonInclude(JsonInclude.Include.USE_DEFAULTS)
    private List<@Valid ViewObject> views;

    /**
     * Add an item to the views property in a chainable fashion.
     *
     * @return The same instance of ViewsResponse for chaining.
     */
    public ViewsResponse addViewsItem(ViewObject viewsItem) {
        if (views == null) {
            views = new ArrayList<>();
        }
        views.add(viewsItem);
