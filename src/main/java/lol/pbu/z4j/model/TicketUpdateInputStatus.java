...
@Serdeable
public enum TicketUpdateInputStatus {
    ...
    public static final Map<String, TicketUpdateInputStatus> VALUE_MAPPING = Map.copyOf(Arrays.stream(values())
     ...
     */
    @JsonCreator
    public static TicketUpdateInputStatus fromValue(String value) {
