...
import lol.pbu.z4j.model.TriggerObject;
...
@Data
@JsonPropertyOrder({
    BatchJobResponseResults.JSON_PROPERTY_TRIGGER_CATEGORIES,
    BatchJobResponseResults.JSON_PROPERTY_TRIGGERS,
})
@Serdeable
public class BatchJobResponseResults {
    ...
    @JsonInclude(JsonInclude.Include.USE_DEFAULTS)
    private List<@Valid TriggerObject> triggers;

    /**
     * Add an item to the triggerCategories property in a chainable fashion.
     *
     * @return The same instance of BatchJobResponseResults for chaining.
     */
    public BatchJobResponseResults addTriggerCategoriesItem(TriggerCategory triggerCategoriesItem) {
     ...
     * @return The same instance of BatchJobResponseResults for chaining.
     */
    public BatchJobResponseResults addTriggersItem(TriggerObject triggersItem) {
        if (triggers == null) {
