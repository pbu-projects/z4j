...
@Data
@JsonPropertyOrder({
    TicketMetricObjectOnHoldTimeInMinutes.JSON_PROPERTY_BUSINESS,
    TicketMetricObjectOnHoldTimeInMinutes.JSON_PROPERTY_CALENDAR,
})
@Serdeable
public class TicketMetricObjectOnHoldTimeInMinutes {
