...
/**
 * <p>Internationalization configuration settings. See <a href=\"#localization\">Localization</a></p>
 */
@Accessors(chain = true)
@NoArgsConstructor
@AllArgsConstructor
@Data
@JsonPropertyOrder(AccountSettingsLocalizationObject.JSON_PROPERTY_LOCALE_IDS)
@Serdeable
public class AccountSettingsLocalizationObject {

    public static final String JSON_PROPERTY_LOCALE_IDS = "locale_ids";
