...
@Data
@JsonPropertyOrder({
    RelationshipFilterDefinition.JSON_PROPERTY_CONDITIONS_ALL,
    RelationshipFilterDefinition.JSON_PROPERTY_CONDITIONS_ANY,
})
@Serdeable
public class RelationshipFilterDefinition {
     ...
     *
     * @return The same instance of RelationshipFilterDefinition for chaining.
     */
    public RelationshipFilterDefinition addConditionsAllItem(TriggerConditionDefinitionObjectAll conditionsAllItem) {
     ...
     * @return The same instance of RelationshipFilterDefinition for chaining.
     */
    public RelationshipFilterDefinition addConditionsAnyItem(TriggerConditionDefinitionObjectAny conditionsAnyItem) {
