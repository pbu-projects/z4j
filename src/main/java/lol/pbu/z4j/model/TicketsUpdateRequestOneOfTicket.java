...
import lol.pbu.z4j.model.CustomFieldObject;
import lol.pbu.z4j.model.EmailCCObject;
import lol.pbu.z4j.model.FollowerObject;
import lol.pbu.z4j.model.TicketCommentObject;
import lol.pbu.z4j.model.TicketCreateVoicemailTicketInputPriority;
...
@Data
@JsonPropertyOrder({
    TicketsUpdateRequestOneOfTicket.JSON_PROPERTY_ADDITIONAL_COLLABORATORS,
    TicketsUpdateRequestOneOfTicket.JSON_PROPERTY_ASSIGNEE_EMAIL,
    TicketsUpdateRequestOneOfTicket.JSON_PROPERTY_ASSIGNEE_ID,
    TicketsUpdateRequestOneOfTicket.JSON_PROPERTY_ATTRIBUTE_VALUE_IDS,
    TicketsUpdateRequestOneOfTicket.JSON_PROPERTY_COLLABORATOR_IDS,
    TicketsUpdateRequestOneOfTicket.JSON_PROPERTY_COMMENT,
    TicketsUpdateRequestOneOfTicket.JSON_PROPERTY_CUSTOM_FIELDS,
    TicketsUpdateRequestOneOfTicket.JSON_PROPERTY_CUSTOM_STATUS_ID,
    TicketsUpdateRequestOneOfTicket.JSON_PROPERTY_DUE_AT,
    TicketsUpdateRequestOneOfTicket.JSON_PROPERTY_EMAIL_CCS,
    TicketsUpdateRequestOneOfTicket.JSON_PROPERTY_EXTERNAL_ID,
    TicketsUpdateRequestOneOfTicket.JSON_PROPERTY_FOLLOWERS,
    TicketsUpdateRequestOneOfTicket.JSON_PROPERTY_GROUP_ID,
    TicketsUpdateRequestOneOfTicket.JSON_PROPERTY_ORGANIZATION_ID,
    TicketsUpdateRequestOneOfTicket.JSON_PROPERTY_PRIORITY,
    TicketsUpdateRequestOneOfTicket.JSON_PROPERTY_PROBLEM_ID,
    TicketsUpdateRequestOneOfTicket.JSON_PROPERTY_REQUESTER_ID,
    TicketsUpdateRequestOneOfTicket.JSON_PROPERTY_SAFE_UPDATE,
    TicketsUpdateRequestOneOfTicket.JSON_PROPERTY_SHARING_AGREEMENT_IDS,
    TicketsUpdateRequestOneOfTicket.JSON_PROPERTY_STATUS,
    TicketsUpdateRequestOneOfTicket.JSON_PROPERTY_SUBJECT,
    TicketsUpdateRequestOneOfTicket.JSON_PROPERTY_TAGS,
    TicketsUpdateRequestOneOfTicket.JSON_PROPERTY_TYPE,
    TicketsUpdateRequestOneOfTicket.JSON_PROPERTY_UPDATED_STAMP,
    TicketsUpdateRequestOneOfTicket.JSON_PROPERTY_ADDITIONAL_TAGS,
    TicketsUpdateRequestOneOfTicket.JSON_PROPERTY_REMOVE_TAGS,
})
@Serdeable
public class TicketsUpdateRequestOneOfTicket {
     ...
     *
     * @return The same instance of TicketsUpdateRequestOneOfTicket for chaining.
     */
    public TicketsUpdateRequestOneOfTicket addAdditionalCollaboratorsItem(CollaboratorObject additionalCollaboratorsItem) {
     ...
     * @return The same instance of TicketsUpdateRequestOneOfTicket for chaining.
     */
    public TicketsUpdateRequestOneOfTicket addAttributeValueIdsItem(Integer attributeValueIdsItem) {
     ...
     * @return The same instance of TicketsUpdateRequestOneOfTicket for chaining.
     */
    public TicketsUpdateRequestOneOfTicket addCollaboratorIdsItem(Integer collaboratorIdsItem) {
     ...
     * @return The same instance of TicketsUpdateRequestOneOfTicket for chaining.
     */
    public TicketsUpdateRequestOneOfTicket addCustomFieldsItem(CustomFieldObject customFieldsItem) {
     ...
     * @return The same instance of TicketsUpdateRequestOneOfTicket for chaining.
     */
    public TicketsUpdateRequestOneOfTicket addEmailCcsItem(EmailCCObject emailCcsItem) {
        if (emailCcs == null) {
     ...
     * @return The same instance of TicketsUpdateRequestOneOfTicket for chaining.
     */
    public TicketsUpdateRequestOneOfTicket addFollowersItem(FollowerObject followersItem) {
        if (followers == null) {
     ...
     * @return The same instance of TicketsUpdateRequestOneOfTicket for chaining.
     */
    public TicketsUpdateRequestOneOfTicket addSharingAgreementIdsItem(Integer sharingAgreementIdsItem) {
     ...
     * @return The same instance of TicketsUpdateRequestOneOfTicket for chaining.
     */
    public TicketsUpdateRequestOneOfTicket addTagsItem(String tagsItem) {
        if (tags == null) {
            tags = new ArrayList<>();
        }
        tags.add(tagsItem);
     ...
     * @return The same instance of TicketsUpdateRequestOneOfTicket for chaining.
     */
    public TicketsUpdateRequestOneOfTicket addAdditionalTagsItem(String additionalTagsItem) {
     ...
     * @return The same instance of TicketsUpdateRequestOneOfTicket for chaining.
     */
    public TicketsUpdateRequestOneOfTicket addRemoveTagsItem(String removeTagsItem) {
        if (removeTags == null) {
