...
@Data
@JsonPropertyOrder({
    TicketCommentObject.JSON_PROPERTY_ATTACHMENTS,
    TicketCommentObject.JSON_PROPERTY_AUDIT_ID,
    TicketCommentObject.JSON_PROPERTY_AUTHOR_ID,
    TicketCommentObject.JSON_PROPERTY_BODY,
    TicketCommentObject.JSON_PROPERTY_CREATED_AT,
    TicketCommentObject.JSON_PROPERTY_HTML_BODY,
    TicketCommentObject.JSON_PROPERTY_ID,
    TicketCommentObject.JSON_PROPERTY_METADATA,
    TicketCommentObject.JSON_PROPERTY_PLAIN_BODY,
    TicketCommentObject.JSON_PROPERTY_PUBLIC,
    TicketCommentObject.JSON_PROPERTY_TYPE,
    TicketCommentObject.JSON_PROPERTY_UPLOADS,
    TicketCommentObject.JSON_PROPERTY_VIA,
})
@Serdeable
public class TicketCommentObject {
     ...
     *
     * @return The same instance of TicketCommentObject for chaining.
     */
    public TicketCommentObject addUploadsItem(String uploadsItem) {
        if (uploads == null) {
