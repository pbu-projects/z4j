...
@Setter
@JsonPropertyOrder({
    ItamAssetField.JSON_PROPERTY_KEY,
    ItamAssetField.JSON_PROPERTY_TITLE,
    ItamAssetField.JSON_PROPERTY_TYPE,
    ItamAssetField.JSON_PROPERTY_ACTIVE,
    ItamAssetField.JSON_PROPERTY_CREATED_AT,
    ItamAssetField.JSON_PROPERTY_CUSTOM_FIELD_OPTIONS,
    ItamAssetField.JSON_PROPERTY_DESCRIPTION,
    ItamAssetField.JSON_PROPERTY_ID,
    ItamAssetField.JSON_PROPERTY_POSITION,
    ItamAssetField.JSON_PROPERTY_RAW_DESCRIPTION,
    ItamAssetField.JSON_PROPERTY_RAW_TITLE,
    ItamAssetField.JSON_PROPERTY_REGEXP_FOR_VALIDATION,
    ItamAssetField.JSON_PROPERTY_RELATIONSHIP_FILTER,
    ItamAssetField.JSON_PROPERTY_SYSTEM,
    ItamAssetField.JSON_PROPERTY_TAG,
    ItamAssetField.JSON_PROPERTY_UPDATED_AT,
    ItamAssetField.JSON_PROPERTY_URL,
    ItamAssetField.JSON_PROPERTY_PROPERTIES,
    ItamAssetField.JSON_PROPERTY_RELATIONSHIP_TARGET_TYPE,
    ItamAssetField.JSON_PROPERTY_REQUIRED,
})
@Serdeable
public class ItamAssetField {
    ...
    public ItamAssetField(String key, String title, String type) {
        this.key = key;
        this.title = title;
        this.type = type;
    }
     ...
     *
     * @return The same instance of ItamAssetField for chaining.
     */
    public ItamAssetField addCustomFieldOptionsItem(CustomFieldOptionObject customFieldOptionsItem) {
