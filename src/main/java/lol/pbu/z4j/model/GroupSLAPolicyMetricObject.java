...
@Data
@JsonPropertyOrder({
    GroupSLAPolicyMetricObject.JSON_PROPERTY_BUSINESS_HOURS,
    GroupSLAPolicyMetricObject.JSON_PROPERTY_METRIC,
    GroupSLAPolicyMetricObject.JSON_PROPERTY_PRIORITY,
    GroupSLAPolicyMetricObject.JSON_PROPERTY_TARGET,
})
@Serdeable
public class GroupSLAPolicyMetricObject {
