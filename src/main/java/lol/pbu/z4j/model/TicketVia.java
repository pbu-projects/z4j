...
@Data
@JsonPropertyOrder({
        TicketVia.JSON_PROPERTY_CHANNEL,
        TicketVia.JSON_PROPERTY_SOURCE,
})
@Serdeable
public class TicketVia {
     ...
     *
     * @return The same instance of TicketVia for chaining.
     */
    public TicketVia putSourceItem(String key, Object sourceItem) {
        if (source == null) {
            source = new HashMap<>();
        }
