...
@AllArgsConstructor
@Data
@JsonPropertyOrder(ActionsObject.JSON_PROPERTY_ACTIONS)
@Serdeable
public class ActionsObject {
     ...
     *
     * @return The same instance of ActionsObject for chaining.
     */
    public ActionsObject addActionsItem(ActionObject actionsItem) {
        if (actions == null) {
