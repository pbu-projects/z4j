...
- **Clients with Active Tests**: 16 / 98 (16.3%)
- **Total Endpoints Declared**: 629
- **Endpoints Tested**: **45 / 629 (7.2%)**
  - 👑 **Admin Level (`adminCtx`)**: 45 endpoints
  - 🛡️ **Agent Level (`agentCtx`)**: 38 endpoints
  - 👤 **End-User Level (`userCtx`)**: 45 endpoints
