...
- **Clients with Active Tests**: 20 / 98 (20.4%)
- **Total Endpoints Declared**: 629
- **Endpoints Tested**: **91 / 629 (14.5%)**
  - 👑 **Admin Level (`adminCtx`)**: 91 endpoints
  - 🛡️ **Agent Level (`agentCtx`)**: 84 endpoints
  - 👤 **End-User Level (`userCtx`)**: 91 endpoints
